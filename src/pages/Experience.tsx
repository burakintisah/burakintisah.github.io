  ...
  const experiences: Experience[] = [
    {
      ...
      achievements: [
        ...
        'Built Cherry Terminal — a POS terminal app and backend from scratch, integrating Celero, Forward, and Dejavoo with custom subflows; processed $2M net payments in 2 months, deployed across 60 devices and 20 locations within 1 month, and fully automated new terminal onboarding.',
        'Built notification workflows handling 200K SMS and 50K emails per day via Twilio and SendGrid.',
        'Refactored a legacy Python search-sync system into a high-throughput Maxwell (CDC)→RabbitMQ→Elasticsearch pipeline, improving latency from 30s to 500ms with 20K events/min throughput.',
        'Upgraded legacy n8n from v0.198 to the latest stable version with zero downtime; migrated 7TB of historical data and resolved 90% of security vulnerabilities.',
        'Built MFA and device auth system adopted by 10K+ users, cutting high-risk login traffic by 50%.',
        'Maintained system health and quality through NewRelic, Grafana, SonarQube, and GitLab CI/CD.',
      ],
      techStack: ['Spring Boot', 'Kotlin', 'Python', 'Maxwell', 'RabbitMQ', 'Elasticsearch', 'n8n', 'Twilio', 'SendGrid', 'NewRelic', 'Grafana', 'SonarQube', 'CI/CD'],
      hasPhotos: true,
      photoFolder: 'Cherry',
    },
    {
